...
// funntion called by scheduled.js
async function monitorDevices(server, token, id) {
  try {
    // find devices to monitor based on agentId
    const devices = await getHostsByAgentId(server, token, id);
